...
In order to support loading of multiple wallets in forextrading-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is forextrading.cpp.
...
Changes to forextrading.cpp
----------------------
forextrading.cpp is the entry point into forextrading-qt, and as such, will require some minor modifications to provide hooks for
