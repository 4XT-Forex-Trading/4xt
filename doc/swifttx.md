...
This mechanism has been integrated into Bitcore-Node-Forex Trading which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ForexTrading-Project/insight-api-forextrading#web-socket-api](https://github.com/ForexTrading-Project/insight-api-forextrading#web-socket-api) 
* API: [https://github.com/ForexTrading-Project/insight-api-forextrading#swifttx-transactions](https://github.com/ForexTrading-Project/insight-api-forextrading#swifttx-transactions) 
...
By default, the Forex Trading daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Forex Trading daemon:
