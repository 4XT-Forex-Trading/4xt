...
#   c) node1 mines 32 blocks, so now node 0 has 600014XT, node 1 has 42504XT, node2 has none.
#   d) node0 sends 601 4XT to node2, in two transactions (301 4XT, then 300 4XT).
