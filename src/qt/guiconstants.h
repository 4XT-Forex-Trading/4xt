...
/* Forex Trading GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Forex Trading"
#define QAPP_ORG_DOMAIN "forextrading.org"
#define QAPP_APP_NAME_DEFAULT "ForexTrading-Qt"
#define QAPP_APP_NAME_TESTNET "ForexTrading-Qt-testnet"
