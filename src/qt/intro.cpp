...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Forex Trading"),
     ...
     * override -datadir in the forextrading.conf file in the default data directory
     * (to be consistent with forextradingd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
