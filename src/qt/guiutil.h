...
/** Utility functions used by the Forex Trading Qt UI.
 */
namespace GUIUtil
{
...
// Render Forex Trading addresses in monospace font
...
// Parse "forextrading:" URI into recipient object, return true on successful parsing
