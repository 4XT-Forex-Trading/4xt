...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Forex Trading forextrading-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  forextrading-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded forextrading transaction") + "\n" +
                               "  forextrading-tx [options] -create [commands]   " + _("Create hex-encoded forextrading transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded forextrading transaction
