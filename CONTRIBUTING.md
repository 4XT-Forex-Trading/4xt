Contributing to Forex Trading
============================

The Forex Trading project operates an open contributor model where anyone is
...
The following applies to code changes to the Forex Trading project, and is not to be
confused with overall Forex Trading Network Protocol consensus changes.

Whether a pull request is merged into Forex Trading rests with the project merge
...
Patches that change Forex Trading consensus rules are considerably more involved than
...
Where a patch set proposes to change the Forex Trading consensus, it must have been
...
The project leader is the release manager for each Forex Trading release.
